...
call s:HL('gitDiff', 'dirtyblonde', '',)

call s:HL('diffDelete', 'dress', '',)
call s:HL('diffAdd', 'lime', 'deepgravel',)
...
call s:HL('diffChange', 'coal', 'lightgravel', 'none')
call s:HL('diffText', 'coal', 'orange', 'bold')
...
" Tag names
call s:HL('htmlTagName',        'lime', '', 'bold')
call s:HL('htmlSpecialTagName', 'saltwatertaffy', '', 'bold')
...
if g:badwolf_html_link_underline
    call s:HL('htmlLink', 'brightgravel', '', 'underline')
else
    call s:HL('htmlLink', 'brightgravel', '', 'none')
endif
